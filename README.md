...
Welcome! Today's assignment will walk you through using Git, GitHub, RStudio to interaction with both, and, along the way, practice using Quarto and R. Cool!

## 1. Clone the template
The first step is to clone this repository into your personal GitHub account so that you can modify it.
